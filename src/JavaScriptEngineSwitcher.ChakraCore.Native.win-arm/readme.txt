   ...
   --------------------------------------------------------------------------------
      README file for JS Engine Switcher: ChakraCore for Windows ARM v3.0.0 RC 1
   ...
   contains the native implementation of ChakraCore version 1.11.1 for Windows (ARM).
