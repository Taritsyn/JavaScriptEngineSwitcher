   ...
   --------------------------------------------------------------------------------
      README file for JS Engine Switcher: ChakraCore for Windows ARM v3.0.0 RC 2
   ...
   contains the native implementation of ChakraCore version 1.11.3 for Windows (ARM).
