   ...
   --------------------------------------------------------------------------------
     README file for JS Engine Switcher: ChakraCore for Windows ARM v3.0.0 Beta 3
   ...
   contains the native implementation of ChakraCore version 1.8.4 for Windows (ARM).
