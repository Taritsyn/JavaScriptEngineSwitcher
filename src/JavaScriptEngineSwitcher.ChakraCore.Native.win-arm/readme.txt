   ...
   --------------------------------------------------------------------------------
         README file for JS Engine Switcher: ChakraCore for Windows ARM v3.1.2
   ...
   contains the native implementation of ChakraCore version 1.11.10 for Windows (ARM).
   ...
   RELEASE NOTES
   =============
   ChakraCore was updated to version 1.11.10.
