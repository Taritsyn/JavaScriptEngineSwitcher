   ...
   --------------------------------------------------------------------------------
      README file for JS Engine Switcher: ChakraCore for Linux x64 v3.0.0 Beta 9
   ...
   contains the native implementation of ChakraCore version 1.10.2 for Linux (x64).
