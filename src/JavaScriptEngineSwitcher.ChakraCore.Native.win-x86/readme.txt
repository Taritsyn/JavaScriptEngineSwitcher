   ...
   --------------------------------------------------------------------------------
         README file for JS Engine Switcher: ChakraCore for Windows x86 v3.1.7
   ...
   contains the native implementation of ChakraCore version 1.11.12 for Windows (x86).

   =============
   RELEASE NOTES
   =============
   1. ChakraCore was updated to version 1.11.12;
