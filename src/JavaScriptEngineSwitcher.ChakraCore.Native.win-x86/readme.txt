   ...
   --------------------------------------------------------------------------------
     README file for JS Engine Switcher: ChakraCore for Windows x86 v3.0.0 Alpha 9
   ...
   contains the native implementation of ChakraCore version 1.7.5 for Windows (x86).
