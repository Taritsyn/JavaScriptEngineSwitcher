   ...
   --------------------------------------------------------------------------------
     README file for JS Engine Switcher: ChakraCore for Windows x86 v3.0.0 Beta 3
   ...
   contains the native implementation of ChakraCore version 1.8.4 for Windows (x86).
   ...
   2. The directory with `win7-x86` RID was renamed to `win-x86`.
