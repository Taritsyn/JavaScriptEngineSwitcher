   ...
   7.0 RC4). When creating this package, an unofficial experimental version of the
   Microsoft ClearScript.V8 (https://github.com/Taritsyn/ClearScript-Experimental)
   library was used.
