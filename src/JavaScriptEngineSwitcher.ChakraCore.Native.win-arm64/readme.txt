   ...
   --------------------------------------------------------------------------------
       README file for JS Engine Switcher: ChakraCore for Windows ARM64 v3.12.6
   ...
   contains the native implementation of ChakraCore version 1.11.24 with the Tomáš
   Deml's patch for Windows (ARM64).
