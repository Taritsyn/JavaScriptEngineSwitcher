   ...
   --------------------------------------------------------------------------------
     README file for JS Engine Switcher: ChakraCore for Windows x64 v3.0.0 Beta 2
   ...
   contains the native implementation of ChakraCore version 1.8.3 for Windows (x64).
