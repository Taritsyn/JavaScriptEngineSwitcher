   ...
   --------------------------------------------------------------------------------
         README file for JS Engine Switcher: ChakraCore for Windows x64 v3.1.3
   ...
   contains the native implementation of ChakraCore version 1.11.11 for Windows (x64).
   ...
   RELEASE NOTES
   =============
   ChakraCore was updated to version 1.11.11.
