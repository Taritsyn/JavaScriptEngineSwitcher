...
namespace JavaScriptEngineSwitcher.ChakraCore.JsRt
{
	...
	internal static class NativeMethods
	{
		...
		[DllImport(DllName.Universal, EntryPoint = "JsAddRef", CallingConvention = DefaultCallingConvention)]
		...
		[DllImport(DllName.Universal, EntryPoint = "JsRelease", CallingConvention = DefaultCallingConvention)]
