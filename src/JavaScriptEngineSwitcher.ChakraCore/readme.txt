   ...
   --------------------------------------------------------------------------------
                README file for JS Engine Switcher: ChakraCore v3.1.10
   ...
   RELEASE NOTES
   =============
   1. ChakraCore was updated to version 1.11.14;
   2. Slightly improved performance;
   3. The `CollectGarbage` method is called synchronously again.
