   ...
   ----------------------------------------------------------------------
           README file for JS Engine Switcher for .Net: Jint 1.5.0
   ...
   (http://github.com/sebastienros/jint) version of March 3, 2016).

   =============
   RELEASE NOTES
   =============
   Jint was updated to version of March 3, 2016.
