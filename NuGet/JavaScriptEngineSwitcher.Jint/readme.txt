   ...
   ----------------------------------------------------------------------
           README file for JS Engine Switcher for .Net: Jint 1.5.1
   ...
   (http://github.com/sebastienros/jint) version of March 6, 2016).

   =============
   RELEASE NOTES
   =============
   Jint was updated to version of March 6, 2016.
