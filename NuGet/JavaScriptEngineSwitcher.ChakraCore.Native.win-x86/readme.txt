   ...
   --------------------------------------------------------------------------------
         README file for JS Engine Switcher: ChakraCore for Windows x86 v2.4.0
   ...
   contains the native implementation of ChakraCore version 1.4.2 for Windows (x86).
   ...
   RELEASE NOTES
   =============
   ChakraCore was updated to version 1.4.2.
