   ...
   -----------------------------------------------------------------------
        README file for JavaScript Engine Switcher for .Net: V8 1.1.9
   ...
   of June 10, 2014 with support of V8 version 3.24.17. For correct
   ...
   RELEASE NOTES
   =============
   Microsoft ClearScript.V8 was updated to version of June 10, 2014.
