   ...
   -----------------------------------------------------------------------
        README file for JavaScript Engine Switcher for .Net: V8 1.2.7
   ...
   5.4.2 with support of V8 version 4.2.77.18. For correct
   ...
   RELEASE NOTES
   =============
   Microsoft ClearScript.V8 was updated to version 5.4.2 (support of V8
   version 4.2.77.18).
