   ...
   --------------------------------------------------------------------------------
     README file for JS Engine Switcher: ChakraCore for Windows ARM v3.0.0 Alpha 3
   ...
   contains the native implementation of ChakraCore version 1.7.2 for Windows (ARM).
