   ...
   ----------------------------------------------------------------------
         README file for JS Engine Switcher for .Net: Jurassic 1.5.1
   ...
   (http://github.com/paulbartrum/jurassic) version of March 5, 2016).

   =============
   RELEASE NOTES
   =============
   Jurassic was updated to version of March 5, 2016.
