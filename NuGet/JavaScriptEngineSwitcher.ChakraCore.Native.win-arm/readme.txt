   ...
   --------------------------------------------------------------------------------
         README file for JS Engine Switcher: ChakraCore for Windows ARM v2.4.28
   ...
   contains the native implementation of ChakraCore version 1.11.2 for Windows (ARM).
   ...
   RELEASE NOTES
   =============
   ChakraCore was updated to version 1.11.2.
